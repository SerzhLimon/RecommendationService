        ...
        "/user/delete": {
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "error: invalid request, incorrect user ID or failed to delete user",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/user/update": {
            "patch": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "error: invalid request, incorrect user ID or failed to update user",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
